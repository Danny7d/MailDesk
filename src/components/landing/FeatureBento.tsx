      ...
      visual: (
        <div className="mt-4 space-y-2">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            <span className="px-2 py-1 bg-gray-100 rounded text-xs">API</span>
            <span className="text-gray-400">→</span>
            <span className="px-2 py-1 bg-gray-100 rounded text-xs">SDK</span>
            <span className="text-gray-400">→</span>
            <span className="px-2 py-1 bg-gray-100 rounded text-xs">Backend</span>
          </div>
          <div className="flex items-center gap-2 text-sm text-blue-600 font-medium">
            <span className="text-gray-400">↓</span>
            <span className="px-2 py-1 bg-blue-100 rounded text-xs">MailDesk</span>
            <span className="text-gray-400">→</span>
            <span className="px-2 py-1 bg-green-100 rounded text-xs">Send</span>
          </div>
        </div>
      ),
    },
    {
      ...
      visual: (
        <div className="mt-3 flex items-center gap-2 text-sm">
          <span className="px-2 py-1 bg-orange-100 text-orange-700 rounded text-xs">Resend</span>
          <span className="text-gray-400">→</span>
          <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs">MailDesk</span>
          <span className="text-gray-400">→</span>
          <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs">Recipient</span>
        </div>
      ),
    },
    {
        ...
        <div className="mt-3 space-y-2">
          {[
            ...
            <div key={i} className="flex items-center justify-between text-xs">
              ...
              <span className="text-green-600 bg-green-50 px-1.5 py-0.5 rounded ml-2 whitespace-nowrap">
                {email.status}
              </span>
            </div>
          ))}
